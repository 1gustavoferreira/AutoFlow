...
import { 
  ...
  TrendingUp, Activity, Check, Edit3, Ban, Undo2
} from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-400">Gestão Transparente de Oficina & Box</p>
            </div>
          </div>

          <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
            <div className="bg-[#18181e] border border-neutral-800 px-4 py-1.5 rounded-xl">
              <span className="text-[10px] text-neutral-400 uppercase font-bold block tracking-wider">Faturado</span>
              <span className="text-sm font-black text-red-400 font-mono">
                R$ {totalRevenue.toFixed(2)}
              </span>
            </div>

            <div className="hidden sm:block bg-[#18181e] border border-neutral-800 px-4 py-1.5 rounded-xl">
              <span className="text-[10px] text-neutral-400 uppercase font-bold block tracking-wider">Em Box</span>
                ...
                {colOrders.length === 0 ? (
                  ...
                  colOrders.map(order => (
                    ...
                    >
                      ...
                      {/* Lista de Peças e Serviços do Card */}
                      ...
                      <div className="flex items-center gap-1.5 pt-2 border-t border-neutral-800">
                        ...
                        <button
                          ...
                          title="Editar OS / Adicionar ou Dispensar Itens"
                        >
                          <Edit3 size={13} />
                        </button>
        ...
        <div className="fixed inset-0 bg-black/85 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#141418] border border-neutral-800 w-full max-w-lg rounded-2xl p-6 shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSaveOrder} onKeyDown={handleKeyDownForm} className="space-y-4">
              ...
              {/* Seção Dinâmica de Peças & Mão de Obra */}
                        ...
                        <div key={it.id} className={`flex items-center justify-between px-3 py-2 rounded-lg text-xs border transition ${
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <button
                              ...
                              title={isDispensado ? "Reativar item na OS" : "Marcar como Dispensado / Não foi necessário trocar"}
                            >
          ...
          <div className="bg-white text-black border border-neutral-300 w-full max-w-sm rounded-xl p-5 shadow-2xl font-mono text-xs space-y-3">
            ...
            <div className="space-y-1 text-[11px]">
              ...
              <div className="flex justify-between">
                ...
                <span>{selectedReceipt.vehiclePlate}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-bold">VEÍCULO:</span>
                <span>{selectedReceipt.vehicleModel}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span>{selectedReceipt.paymentMethod || 'Aberto'}</span>
              </div>
            </div>
                  ...
                  {selectedReceipt.items.map((it, idx) => {
                    ...
                    return (
                      <div key={idx} className={`flex justify-between text-[11px] ${isDisp ? 'text-neutral-500 line-through' : ''}`}>
                        <span>
                          {isDisp ? '[DISPENSADO] ' : `[${it.type === 'PECA' ? 'P' : 'S'}] `}
                          {it.name}
                        </span>
